...
export default function FAQ() {
  return (
    <div className="container flex flex-col justify-between gap-10 px-6 sm:flex-row">
      ...
      <div className="flex-shrink-0 p-6 rounded-lg bg-SecondaryPumpkin h-min sm:basis-72 lg:basis-80 text-PrimaryPumpkin">
        ...
        <button className="px-6 py-4 mt-6 font-semibold border rounded-lg text-PrimaryPumpkin bg-SecondaryPumpkin border-PrimaryPumpkin">
          Chat with us
        </button>
      </div>
    </div>
